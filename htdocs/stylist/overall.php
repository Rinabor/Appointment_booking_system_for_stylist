...
<head>
    ...
    <style>
        ...
        .status-cards .card:first-child {
            background: linear-gradient(135deg, #4CAF50 0%, #81C784 100%); /* Green gradient for completed */
            color: white;
        }
        .status-cards .card:nth-child(2) {
            background: linear-gradient(135deg, #F44336 0%, #E57373 100%); /* Red gradient for cancelled */
            color: white;
        }
        .calendar-container {
            background: linear-gradient(135deg, #2196F3 0%, #64B5F6 100%); /* Blue gradient for calendar */
            color: white;
        }
        .chart-container {
            background: linear-gradient(135deg, #FF9800 0%, #FFB74D 100%); /* Orange gradient for chart */
            color: white;
        }
